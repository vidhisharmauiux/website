      ...
      <div className="content-max">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-3" ref={textRef}>
            ...
            >
              I&rsquo;m Vidhi Sharma, a mural artist and doodle creator based in
              Rajasthan, India. What started as sketching in the margins of
              notebooks grew into a calling to transform the spaces people
              inhabit every day.
            </p>
            <p
              className="reveal-item font-body font-light leading-relaxed mb-6"
            ...
            >
              My work lives at the intersection of fine art and street culture —
              intricate doodle patterns that flow into bold mural compositions.
              I&rsquo;ve painted walls in cafés across Jaipur, restored heritage
              building façades in Udaipur, and created intimate canvas works for
              collectors in Delhi and Mumbai.
            </p>
            <p
            ...
            >
              Each project is a collaboration between my vision and your
              space&rsquo;s inherent story. When I&rsquo;m not painting,
              you&rsquo;ll find me exploring Rajasthan&rsquo;s ancient
              architecture, collecting textures and patterns that find their way
              into my work.
            </p>
            <a
