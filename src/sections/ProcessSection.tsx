...
const STEPS = [
  {
    ...
    image: '/images/process-conversation.png',
  },
  {
    num: '02',
    title: 'The Vision',
  ...
  },
  {
    ...
    image: '/images/process-reveal.png',
  },
];
  ...
  useEffect(() => {
    ...
    return () => {
      ScrollTrigger.getAll()
        .filter((st) => st.trigger === section || st.trigger === steps || Array.from(stepEls).includes(st.trigger as Element))
        .forEach((st) => st.kill());
    };
  }, []);
